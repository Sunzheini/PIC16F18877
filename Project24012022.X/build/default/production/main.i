...
void lcd_init()
{
 lcd_cmd(0x38); _delay((unsigned long)((5)*(1000000/4000.0)));
 lcd_cmd(0x02); _delay((unsigned long)((5)*(1000000/4000.0)));
 lcd_cmd(0x01); _delay((unsigned long)((5)*(1000000/4000.0)));
 lcd_cmd(0x0C); _delay((unsigned long)((5)*(1000000/4000.0)));
 lcd_cmd(0x06); _delay((unsigned long)((5)*(1000000/4000.0)));
 lcd_cmd(0x80); _delay((unsigned long)((5)*(1000000/4000.0)));
}
...
void main(void)
{
    ...
    adc_result_t voltage=0;
    unsigned int temp_holder=0;
...
# 236 "main.c"
  ...
  voltage = ADCC_GetSingleConversion(channel_ANA1);
        ...
        lcd_data('C');
# 269 "main.c"
  lcd_out(2,10,"       "); _delay((unsigned long)((5)*(1000000/4000.0)));
